    ...
    <div class="py-4 right_width">
        @if (empty($lawyerFee))
            <div class="alert alert-warning" role="alert">
                <i class="fa fa-info-circle me-2" style="font-size:18px"></i>Your profile will not be published until you set
                your hourly rate!
            </div>
        @endif
        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="ld_card">
                    <div class="card-body">
                        <img src="{{ asset('assets/frontend/media/lawyer/user-group-man-woman.png') }}" alt="clients"
                            style="width:50px">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="ld_card">
                    <div class="card-body">
                        <img src="{{ asset('assets/frontend/media/lawyer/parallel-tasks.png') }}" alt="practice-areas"
                            style="width:50px">
