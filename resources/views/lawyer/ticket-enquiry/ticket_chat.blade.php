                ...
                <div class="card-header d-flex align-items-center justify-content-between"
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="btn btn-sm btn-icon btn-active-light-primary" id="kt_drawer_chat_close">
                            <a href="{{ route('lawyer.ticket_enquiries') }}" type="button" class="btn btn-secondary"><span
                        ...
                        @foreach ($messages as $message)
                            <div class="row no-gutters" style="margin: 10px;">
                                <div
                                    ...
                                    <div
                                        class="chat-bubble @if ($message->sender_id == Auth::user()->id) chat-bubble--right @else chat-bubble--left @endif">
