...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-9 col-lg-9 col-xl-9 py-4 right_width">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-between" id="kt_drawer_chat_messenger_header">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex justify-content-center flex-column me-3">
                                <a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 lh-1">{{isset($enquiry->title)? $enquiry->title :''}}</a>
                            </div>
                            <!--end::User-->
                        </div>
                        <div class="card-toolbar">
                            ...
                            <div class="btn btn-sm btn-icon btn-active-light-primary" id="kt_drawer_chat_close">
                                <a href="{{route('lawyer.ticket_enquiries')}}" type="button" class="btn btn-secondary"><span class="svg-icon svg-icon-2">
