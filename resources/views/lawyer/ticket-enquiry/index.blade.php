        ...
        <div class="col col-xl-9 py-lg-5 py-4 right_width">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div style="padding: 5px;">
                    <a href="{{ route('lawyer.ticket_enquiries_create') }}" type="button" class="btn btn-primary">
                    ...
                    <table class="table table-striped table-bordered text-center schedules_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="{{route('lawyer.join_chat',base64_encode($ticket->id))}}" class="btn" style="background:#337ab7;color:#fff"><b><i class="fa fa-reply"></i></b></a>
                                </div>
                                </td>
                            </tr>
                            @endforeach
