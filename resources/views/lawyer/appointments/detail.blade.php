            ...
            <div class="col py-lg-5 py-4 right_width right_width">
                ...
                <div style="width:100%; height:100%; overflow-x: auto">
                    ...
                    <div class="mt-3 d-grid gap-1 d-flex justify-content-md-end">
                        <div class="btn-style py-2"><a href="{{route('lawyer.appointment.index')}}" class="btn-sm ms-auto py-1 px-3" id="next_legal"><i class="fa fa-chevron-left me-2"></i>Back</a></div>
                    </div>
                </div>
