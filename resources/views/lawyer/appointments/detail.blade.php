    ...
    <div class="py-4 right_width">
        ...
        <div style="width:100%; height:100%; overflow-x: auto">
            <table class="table table-striped table-bordered text-left">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div>
                                <a href="{{ asset('public/' . isset($appointment->case_file) ? $appointment->case_file : '') }}"
                ...
                <table class="table table-striped table-bordered text-left">
                    <tbody>
                        <tr>
                            ...
                            <td width="60%">
                                ${{ isset($appointment->service_price) ? $appointment->service_price : '0' }}</td>
                        </tr>
                        <tr>
                            <th class="text-center">2</th>
            ...
            <div class="mt-3 d-grid gap-1 d-flex justify-content-md-end">
                <div class="btn-style py-2"><a href="{{ route('lawyer.appointment.index') }}"
                        class="btn-sm ms-auto py-1 px-3" id="next_legal"><i class="fa fa-chevron-left me-2"></i>Back</a>
                </div>
            </div>
        </div>
    </div>
