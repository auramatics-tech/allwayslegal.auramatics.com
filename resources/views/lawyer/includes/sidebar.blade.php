<div class="db_sidebar py-lg-4 py-3">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-lg-3 px-2 pt-2 text-white min-vh-100">
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li class="nav-item">
                <a href="{{ route('lawyer.dashboard') }}" class="nav-link @if (Route::is('lawyer.dashboard')) active @endif align-middle">
            ...
            <li>
                <a href="{{ route('lawyer.appointment.index') }}" class="position-relative nav-link align-middle @if (Route::is('lawyer.appointment.index') || Route::is('lawyer.appointment.detail')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
