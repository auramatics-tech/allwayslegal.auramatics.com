                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12 lp_card_1" style="font-size:17px; line-height:21.5px">
                                    <p><i class="fa fa-briefcase me-2"></i>
                                        <span> Position:</span> {{ isset(Auth::user()->lawyer->position)?Auth::user()->lawyer->position: '' }}
                                    </p>
                                    <p><i class="fa fa-building me-2"></i>
                                        <span>Law Firm:</span> {{ isset(Auth::user()->lawyer->law_firm_name) ? Auth::user()->lawyer->law_firm_name : '' }}
                                    </p>
                                    <p><i class="fa fa-map-marker me-2"></i>
                                        <span>Location:</span> {{ isset(Auth::user()->lawyer->get_city->name) ? Auth::user()->lawyer->get_city->name : '' }}
                                ...
                                <div class="col-md-6 col-12 lp_card_2">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p>{{ isset(Auth::user()->lawyer->specialized_at)?Auth::user()->lawyer->specialized_at: '' }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            <h5>Enrolment year</h5>
                                            <p>{{ isset(Auth::user()->lawyer->enrolment_year)?Auth::user()->lawyer->enrolment_year: '' }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 pb-3 lp_card_3" style="color:#337ab7">
                            ...
                            @foreach (Auth::user()->lawyer->areas as $area)
                                <span class="btn py-2 px-3 border me-md-3 me-1 mb-lg-3 mb-2">{{ isset($area->name)?$area->name:'' }}</span>
                            @endforeach
                            @endif
