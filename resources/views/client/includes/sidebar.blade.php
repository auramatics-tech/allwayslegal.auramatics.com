<div class="db_sidebar py-lg-4 py-3">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-lg-3 px-2 pt-2 text-white min-vh-100">
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li class="nav-item">
                <a href="{{ route('client.dashboard') }}" class="nav-link @if (Route::is('lawyer.dashboard')) active @endif align-middle">
            ...
            <li>
                <a href="@if(Auth::user()->client){{ route('client.appointment.index') }} @else {{ route('lawyer.appointment.index') }} @endif" class="nav-link align-middle @if (Route::is('client.appointment.index') || Route::is('client.appointment.detail')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            @if(Auth::user()->lawyer)
            <li>
                <a href="{{ route('lawyer.schedules') }}" class="nav-link align-middle @if (Route::is('lawyer.schedules')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <li>
                <a href="{{ route('lawyer.practice_areas') }}" class="nav-link align-middle @if (Route::is('lawyer.practice_areas')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <li>
                <a href="{{ route('lawyer.services.index') }}" class="nav-link align-middle @if (Route::is('lawyer.services.index')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            @endif
            <li>
                <a href="{{ route('messages.index') }}" class="nav-link align-middle @if (Route::is('messages.index')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <li>
                <a href="#" class="nav-link align-middle @if (Route::is('detail_review')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <li>
                <a href="{{ route('change_password') }}" class="nav-link align-middle @if (Route::is('change_password')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <li>
                <a href="{{ route('client.ticket_enquiry') }}" class="nav-link align-middle @if (Route::is('client.ticket_enquiry')) active @endif">
                    <span class="svg-icon svg-icon-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
