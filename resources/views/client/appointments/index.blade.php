                                ...
                                <td>
                                    <div class="dropdown pl_action_drop">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1" style="width:168px">
                                            <li><a href="{{ route('client.appointment.detail', ['id' => isset($appointment->id) ? $appointment->id : '']) }}"
                                        ...
                                        data-end="{{ isset($appointment->end_time) ? date_format($appointment->end_time, 'H:i') : '' }}">Reschedule</button> --}}
                                                    ...
                                                    <li><a href="{{ route('reschedule_time', ['id' => isset($appointment->id) ? $appointment->id : '']) }}"
                                                            class="text-dark px-3 py-2">Reschedule</a></li>
                                                @endif
                                            @endif
                                            @if (isset($appointment->status) &&
                                                    ($appointment->status == 2 ||
                                                        (empty($appointment->status) && $appointment->status == 5) ||
                                                        (empty($appointment->status) && $appointment->status == 6)))
                                                @if (isset($appointment->date) && !empty($appointment->date) && ($appointment->status == 2 || $appointment->status == 5))
                                                    <li> <a id="hire"
                                                            href="{{ route('confirmation', ['id' => isset($appointment->id) ? $appointment->id : '']) }}"
                                                            class="text-dark px-3 py-2">Continue</a></li>
                                                @else
                                                    <li><a id="hire"
                                                            href="{{ route('schedule_time', ['id' => isset($appointment->id) ? $appointment->id : '']) }}"
                                                            class="text-dark px-3 py-2">Hire</a></li>
                                                @endif
                                            @endif
                                            @if ($appointment->isCancelled() && $appointment->status == 5)
                                                <li><a href="{{ route('confirmation', ['id' => isset($appointment->id) ? $appointment->id : '']) }}"
                                                        class="text-dark px-3 py-2">Continue</a></li>
                                            @endif
                                            @if (isset($appointment->status) &&
                                                ...
                                                @endif
                                            @else
                                                <li><a href="{{ route('client.appointment.cancel_request', ['id' => isset($appointment->id) ? $appointment->id : '']) }}"
