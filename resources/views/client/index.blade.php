        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-lg-0 mt-4">
                <div class="client_card shadow-sm mb-3">
                    ...
                    <div class="ms-auto">
                        <div class="btn-style py-2"><a href="{{ route('dashboard.messages.index') }}" class="btn-sm ms-auto">Chat<i
                            ...
                            @foreach ($ongoing_appointments as $ongoing_appointment)
                                <div class="d-flex align-items-center law_grow_div border-0">
                                    ...
                                    <div class="flex-grow-1">
                                        <a href="{{ route('client.appointment.detail', ['id' => isset($ongoing_appointment->id) ? $ongoing_appointment->id : '']) }}"
                                            class="fs-5 lh-sm">#{{ isset($ongoing_appointment->booking_code) ? $ongoing_appointment->booking_code : '' }}</a>
                                        <span class="d-block fs-14px">In
                                            {{ isset($ongoing_appointment->days_until_appointment) ? $ongoing_appointment->days_until_appointment : '' }}
                                            @if (isset($ongoing_appointment->days_until_appointment) && $ongoing_appointment->days_until_appointment > 1)
                                                Days
                                            @else
                                                Day
                                            @endif
                                ...
                                <div class="d-flex align-items-center law_grow_div">
                                    <div class="me-3">
                                        <img src="{{ asset('assets/backend/media/avatars/blank.png') }}"
                                            class="img-thumbnail" alt="" style="width:60px; height:60px">
                                    </div>
                                    <div class="flex-grow-1">
                                        <a href="#"
                                            class="fs-5 lh-sm">{{ isset($lawyer->first_name) ? $lawyer->first_name : '' }}
                                            {{ isset($lawyer->last_name) ? $lawyer->last_name : '' }}</a>
                                        <span class="d-block fs-14px">
                                            @if (isset($lawyer->city) || isset($lawyer->province))
                                                <div class="mb-3"><span class="ms-0"><i
                                                            class="fa fa-2x fa-map-marker me-2"
                    ...
                    <div class="col-md-4 col-12">
                        <div class="client_service_card mb-3">
                            ...
                            <p class="mb-0"><a href="#" data-bs-toggle="modal"
                                    data-bs-target="#serviceModal_{{ $key }}">View
                                    Details</a>
                            </p>
                        </div>
                    </div>
                    <!-- Modal -->
                    <div class="modal fade" id="serviceModal_{{ $key }}" tabindex="-1" role="dialog"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">
                                        {{ isset($service->title) ? $service->title : '' }}</h5>
