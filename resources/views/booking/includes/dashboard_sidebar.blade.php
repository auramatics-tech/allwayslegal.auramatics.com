    ...
    <div class="d-flex flex-column align-items-center align-items-sm-start px-lg-3 px-2 pt-2 text-white min-vh-100">
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            @if (Auth::user()->lawyer)
                ...
                <li>
                    <a href="{{ route('lawyer.practice_areas') }}"
                        class="nav-link align-middle @if (Route::is('lawyer.practice_areas')) active @endif">
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path opacity="0.3"
                ...
                <li>
                    <a href="{{ route('lawyer.services.index') }}"
                        class="nav-link align-middle @if (Route::is('lawyer.services.index')) active @endif">
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
            ...
            @if (Auth::user()->lawyer)
                <li>
                    <a href="{{ route('lawyer.ticket_enquiries') }}"
                        class="nav-link align-middle @if (Route::is('lawyer.ticket_enquiries')) active @endif">
                        <span class="svg-icon svg-icon-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none">
                                <path
