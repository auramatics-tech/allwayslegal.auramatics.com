                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            @if (Auth::user()->profile_photo_path)
                                <img alt="Logo" src="{{ asset('user_profile/' . Auth::user()->profile_photo_path) }}"
                                    alt="user" />
                            @else
                                <img src="{{ asset('assets/backend/media/avatars/blank.png') }}" alt="user" />
                            @endif
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        @if (Auth::user()->profile_photo_path)
                                            <img alt="Logo"
                                                src="{{ asset('user_profile/' . Auth::user()->profile_photo_path) }}" />
                                        @else
                                            <img alt="Logo"
                                                src="{{ asset('assets/backend/media/avatars/blank.png') }}" />
                                        @endif
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
