        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.user')) active @endif" href="{{ route('admin.user') }}">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.practice_area')) active @endif" href="{{ route('admin.practice_area') }}">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.service')) active @endif" href="{{ route('admin.service') }}">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.contact_us_listing')) active @endif" href="{{ route('admin.contact_us_listing') }}">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.appointments')) active @endif" href="{{ route('admin.appointments') }}">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.lawyers')) active @endif" href="{{ route('admin.lawyers') }}">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.clients')) active @endif" href="{{ route('admin.clients') }}">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.schedule')) active @endif" href="{{ route('admin.schedule') }}">
                ...
                <div class="menu-item menu-accordion">
                    ...
                    <a class="menu-link @if (Route::is('admin.ticket')) active @endif" href="{{ route('admin.ticket') }}">
