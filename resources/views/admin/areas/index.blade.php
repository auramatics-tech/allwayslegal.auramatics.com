    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> Practice Areas
                    <!--begin::Description-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <form class="d-flex align-items-center position-relative my-1" method="get">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" class="form-control w-250px ps-14" placeholder="Search Area"
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-area-table-toolbar="base">
                            <!--begin::Add area-->
                            <a href="{{ Route('admin.create_area') }}" type="button" class="btn btn-primary">
                ...
                <div class="card-body pt-0">
                    ...
                    <div id="kt_table_services_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                    ...
                                    @if (count($areas))
                                        @foreach ($areas as $key => $area)
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    @if($area->image)
                                                    <img src="{{asset('practice_area_images/'.$area->image)}}" alt="" class="img-thumbnail" style="width:80px; height:80px;">
                                                    @else
                                                    <img src="{{asset('assets/backend/media/thumbnail.png')}}" alt=""  style="width:80px; height:80px;">
                                                    @endif
                                                </td>
                                                <td class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="#"
                                                            class="text-gray-800 text-hover-primary mb-1">{{ $area->name }}
                                                        </a>
                                                    </div>
                                                    <!--begin::area details-->
                                                </td>
                                                <td data-order="2023-01-08T12:00:52+05:30">
                                                        {{ date('F d, Y', strtotime($area->created_at)) }}
                                                </td>
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                                    <a href="#"
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('admin.edit_area', $area->id) }}"
                                                                class="menu-link px-3">Edit</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="javascript:" rel="{{ $area->id }}"
                                                                rel1="delete-area"
                        ...
                        <div class="row text-end">
                            {{ $areas->withQueryString()->onEachSide(0)->links('pagination::bootstrap-4') }}
                        </div>
                    </div>
                    <!--end::Table-->
                </div>
