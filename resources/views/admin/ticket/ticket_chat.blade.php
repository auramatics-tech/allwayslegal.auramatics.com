                            ...
                            <div class="card-header px-0" id="kt_drawer_chat_messenger_header">
                                ...
                                <div class="card-title">
                                    ...
                                    <div class="d-flex justify-content-center flex-column me-3">
                                        <a href="#" class="fs-4 fw-bolder text-gray-900 text-hover-primary me-1 mb-2 lh-1">{{isset($enquiry->user_name)?$enquiry->user_name : ''}}</a>
                                        <!--begin::Info-->
                                        <div class="mb-0 lh-1">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="btn btn-sm btn-icon btn-active-light-primary" id="kt_drawer_chat_close">
                                        ...
                                        <a href="{{ route('admin.ticket') }}" type="button" class="btn btn-secondary"><span class="svg-icon svg-icon-2">
                            ...
                            <div class="chat-panel">
                                <div class="message_section mb-5" id="chat" style="height: calc(100vh - 382px);overflow-y: auto;">
                                    ...
                                    <div class="row no-gutters" style="margin: 10px;">
                                        <div class="col-xl-5 col-lg-5 col-md-8 col-11 @if($message->user_id == Auth::user()->id) ms-auto send @else me-auto receive @endif">
                                            <div class="chat-bubble @if($message->sender_id == Auth::user()->id) chat-bubble--right @else chat-bubble--left @endif">
                                                <p class="user_name">{{ucfirst($message->user_name)}}</p>
                                                <p>
                                                    @if($message->type == 'text')
                                                    {{$message->message}}
                                                    @else
                                                    <a href="{{asset('query_image/' . $message->message)}}" target="_blank" class="card p-1"><i class="o mr-1" aria-hidden="true"></i>{{$message->message}}</a>
                                                    @endif
                                                    <br><br>
                                                    <span class="text-grey">{{Carbon\Carbon::createFromFormat('Y-m-d H:i:s',$message->created_at,'UTC')->setTimezone('Asia/Kolkata')->format('H:i')}}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form action="" method="post" class="px-3" id="chat_form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="d-flex align-items-center chat-box-tray mx-auto w-100 gap-3">
                                        <div class="d-flex gap-3 align-items-center w-100">
                                            ...
                                            <textarea autofocus style="border: 1px solid #eff2f5;" autofocus name="msg_box" id="msg_box" rows="1" class="w-100 form-control" placeholder="Type here..."></textarea>
                                        ...
                                        <div class="text-right d-flex gap-4">
                                            <!-- <span class="mx-1"><img src="{{ asset('care_team/svg/media.svg') }}" alt=""></span> -->
