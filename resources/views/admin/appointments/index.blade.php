                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_services">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-end min-w-50px sorting_disabled" rowspan="1" colspan="1" aria-label="Actions">Actions</th>
                                ...
                                <tr class="odd">
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="{{ route('admin.appointments_details',$appointment->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $appointment->booking_code }}
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                            <div class="menu-item px-3">
                                                ...
                                                <a href="{{ route('admin.appointments_details',$appointment->id) }}" class="menu-link px-3">Details</a>

                                            </div>
                                            @if (isset($appointment->payment_release) &&
                                            $appointment->payment_release == 1)
                                            <div class="menu-item px-1">
                                                <a class="menu-link px-3 approve_btn" data-id="{{$appointment->id}}">Payment Status</a>
                                            </div>
                                            @endif
                                            <div class="menu-item px-3">

                                                <a href="{{ route('admin.chat',$appointment->id) }}" class="menu-link px-3">View Chat</a>
