...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> All Booking
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <div id="kt_table_services_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                ...
                                <tr class="odd">
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="" class="text-gray-800 text-hover-primary mb-1">{{ isset($bookings->booking_code) ? $bookings->booking_code : '' }}
                                    ...
                                    <td>{{ isset($bookings->area_name) ? $bookings->area_name : '' }}</td>

                                    <td>{{ isset($bookings->service_title) ? $bookings->service_title : '' }}</td>

                                    <td>{{ isset($bookings->client_name) ? $bookings->client_name : '' }}</td>

                                    {{-- --}}

                                    <td>{{ isset($bookings->case_title) ? $bookings->case_title : '' }}</td>

                                    <td>
                                        @if (isset($bookings->status) && $bookings->status == 1)
                                        <span class="pl_badge pl_bg_warning">Requested</span>
                                        @elseif(isset($bookings->status) && $bookings->status == 2)
                                    ...
                                    {{--<td data-order="2023-01-08T12:00:52+05:30">
                                        ...
                                        {{ date('F d, Y', strtotime($bookings->created_at)) }}
                    ...
                    {{ $booking->withQueryString()->onEachSide(0)->links('pagination::bootstrap-4') }}
