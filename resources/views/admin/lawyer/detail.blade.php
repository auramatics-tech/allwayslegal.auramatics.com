...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> Lawyer Detail
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                <tr>
                                    ...
                                    <td>{{ isset($lawyer->get_country->name) ? $lawyer->get_country->name : '' }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ isset($lawyer->get_city->name) ? $lawyer->get_city->name: '' }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ isset($lawyer->get_province->name) ? $lawyer->get_province->name : '' }}</td>
