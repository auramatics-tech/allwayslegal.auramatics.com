...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"> Lawyers
            ...
            <div class="card-body pt-0">
                ...
                <div id="kt_table_services_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                ...
                                <tr class="odd">
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ isset($lawyer->first_name) ? $lawyer->first_name : '' }}
                                    ...
                                    <td>{{ isset($lawyer->country_name) ? $lawyer->country_name : '' }}</td>

                                    <td>{{ isset($lawyer->city_name) ? $lawyer->city_name : '' }}</td>
                                    ...
                                    <td data-order="2023-01-08T12:00:52+05:30">
                                        ...
                                        {{ date('F d, Y', strtotime($lawyer->created_at)) }}
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <a href="{{ route('admin.lawyer_detail',$lawyer->id) }}" class="menu-link px-3">Detail</a>

                                            </div>

                                            <div class="menu-item px-3">

                                                <a href="{{ route('admin.lawyer_bookings',$lawyer->id) }}" class="menu-link px-3">All Bookings</a>

                                            </div>

                                            <div class="menu-item px-25">

                                                <a href="{{ route('admin.lawyer_upcoming_bookings',$lawyer->id) }}" class="menu-link px-3">Upcoming Bookings</a>

                                            </div>
                                            @if($lawyer->user->status == 1)
                                            <div class="menu-item px-3">
                                                <a href="{{route('admin.change_status', $lawyer->id)}}" title="Set Pending" class="menu-link px-3">Pending</a>
                                            </div>
                                            @else
                                            <div class="menu-item px-3">
                                                <a href="{{route('admin.change_status', $lawyer->id)}}" title="Set Approved" class="menu-link px-3">Approved</a>
                                            </div>
                                            @endif
                    ...
                    <div class="row text-end">
                        ...
                        {{ $lawyers->withQueryString()->onEachSide(0)->links('pagination::bootstrap-4') }}
