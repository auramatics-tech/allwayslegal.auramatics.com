                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <form class="d-flex align-items-center position-relative my-1" method="get">
                            ...
                            <input type="text" class="form-control w-250px ps-14" placeholder="Search Lawyer"
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <a href="{{ route('admin.lawyer_detail', $lawyer->id) }}"
                                                            class="text-gray-800 text-hover-primary mb-1">{{ isset($lawyer->name) ? $lawyer->name : '' }}
                                                        </a>
                                                ...
                                                <td>{{ isset($lawyer->email) ? $lawyer->email : '' }}</td>
                                                <td>
                                                    @if ($lawyer->status == 1)
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            ...
                                                            <a href="{{ route('admin.lawyer_bookings', $lawyer->id) }}"
                                                                class="menu-link px-3">All Bookings</a>

                                                        </div>

                                                        <div class="menu-item px-25">

                                                            <a href="{{ route('admin.lawyer_upcoming_bookings', $lawyer->id) }}"
                                                                class="menu-link px-3">Upcoming Bookings</a>

                                                        </div>
                                                        @if ($lawyer->status == 1)
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('admin.change_status', $lawyer->id) }}"
                                                                    title="Set Pending" class="menu-link px-3">Pending</a>
                                                            </div>
                                                        @else
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('admin.change_status', $lawyer->id) }}"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="javascript:" rel="{{ $lawyer->id }}"
                                                                rel1="delete-lawyer"
